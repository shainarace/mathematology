...
setwd('/Users/shaina/Library/Mobile Documents/com~apple~CloudDocs/Data Mining 2020/Code')
load("Hitters.Rdata")
...
library(glmnet)
set.seed(1)
cv.out = cv.glmnet(X[train,], y[train], alpha=0) #' Only using training data
                                                              #' for CV!
plot(cv.out)
